...
namespace SDD.Transaction.Entities
{
    ...
    [DisplayName("Fcm Message User"), InstanceName("Fcm Message User")]
    [ReadPermission("Transaction:FcmMessageUser")]
    ...
    public sealed class FcmMessageUserRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Id Parent Message Id User Share"), Expression("jIdParentMessage.[IdUserShare]")]
        public Int32? IdParentMessageIdUserShare
        {
            get { return Fields.IdParentMessageIdUserShare[this]; }
            set { Fields.IdParentMessageIdUserShare[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field IdParentMessageIdUserShare;
        }
    }
}
